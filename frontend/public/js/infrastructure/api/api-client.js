...
export class ApiClient {
    ...
    async getInvitation(code) {
        ...
        try {
            return await this.get(`/api/invitation/${encodeURIComponent(code)}`);
        } catch (error) {
    ...
    async confirmInvitation(code, confirmationData) {
        ...
        const requiredFields = ['attendance', 'guestName'];
        const missingFields = requiredFields.filter(field => !confirmationData[field]);
        ...
        try {
            return await this.post(`/api/invitation/${encodeURIComponent(code)}/confirm`, {
                ...confirmationData,
    ...
    async getInvitationStats() {
        try {
            return await this.get('/api/invitations/stats');
        } catch (error) {
