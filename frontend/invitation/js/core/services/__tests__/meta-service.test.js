...
describe('MetaService', () => {
  ...
  describe('Initialization', () => {
    ...
    it('no debe inicializar dos veces', async () => {
      ...
      expect(spy).not.toHaveBeenCalledWith(expect.stringContaining('Initializing MetaService'));
      spy.mockRestore();
    });
  ...
  describe('Meta Batch Configuration', () => {
    it('debe aplicar configuración de meta tags múltiples', () => {
      ...
      expect(document.querySelector('meta[name="description"]').getAttribute('content'))
        .toBe('Invitación a nuestra boda');
  ...
  describe('Edge Cases', () => {
    ...
    it('debe permitir caracteres especiales en URLs', () => {
      const url = 'https://example.com/image.jpg?size=large&format=webp&v=1.0&signature=abc123';
